...
class Madapay
{
    public function __construct($redirect = false, $lang = false)
    {
        ...
        $this->testmode = config('madapay.testmode');
        $this->currency = config('madapay.currency');
        $this->title = config('madapay.title');
        $this->trans_type = config('madapay.trans_type');
        $this->trans_mode = config('madapay.trans_mode');
        $this->accesstoken = config('madapay.accesstoken');
        $this->entityid = config('madapay.entityId');
        $this->brands = config('madapay.brands');
        $this->connector_type = config('madapay.connector_type');
        $this->payment_style = config('madapay.payment_style');
        $this->mailerrors = 'no';
        ...
        $this->tokenization = config('madapay.tokenization');
                ...
                var wpwlOptions = {
                    ...
                    onReady: function() {
                        ...
                        ?>
                            ...
                            console.log(createRegistrationHtml)
