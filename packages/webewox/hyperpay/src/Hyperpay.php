...
class Hyperpay
{
    public function __construct($redirect = false, $lang = false)
    {
        ...
        $this->testmode = config('hyperpay.testmode');
        $this->currency = config('hyperpay.currency');
        $this->title = config('hyperpay.title');
        $this->trans_type = config('hyperpay.trans_type');
        $this->trans_mode = config('hyperpay.trans_mode');
        $this->accesstoken = config('hyperpay.accesstoken');
        $this->entityid = config('hyperpay.entityId');
        $this->brands = config('hyperpay.brands');
        $this->connector_type = config('hyperpay.connector_type');
        $this->payment_style = config('hyperpay.payment_style');
        $this->mailerrors = 'no';
        ...
        $this->tokenization = config('hyperpay.tokenization');
    ...
    {
        return config('hyperpay.enabled');
    }
